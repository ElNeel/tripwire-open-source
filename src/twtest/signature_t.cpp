...
void assertSHA256(const std::string& source, const std::string& expectedHex)
{
    // Signature usage example (?)
    cSHA256Signature     shaSig;
...
void assertSHA512(const std::string& source, const std::string& expectedHex)
{
    // Signature usage example (?)
    cSHA512Signature     shaSig;
...
void TestFips180Sha256()
{
    // SHA-256 test vectors from FIPS-180 standard
    // https://csrc.nist.gov/CSRC/media/Projects/Cryptographic-Standards-and-Guidelines/documents/examples/SHA256.pdf

    // TODO: Maybe add NIST's additional test vectors & results from here:
    // https://csrc.nist.gov/CSRC/media/Projects/Cryptographic-Standards-and-Guidelines/documents/examples/SHA2_Additional.pdf
    // plus the really large tests from the first pdf, except maybe the 1GB one.
...
void TestFips180Sha512()
{
    // SHA-512 test vectors from FIPS-180 standard
    ...
    assertSHA512("", "cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3e");

    assertSHA512("abc",    "ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f");
...
void RegisterSuite_Signature()
{
    ...
    RegisterTest("Signature", "Fips180Sha256", TestFips180Sha256);
    RegisterTest("Signature", "Fips180Sha512", TestFips180Sha512);
}
